	...
	public boolean equals(Object obj) {
		...
		if (!(obj instanceof Book4)) 
			...
			/* ★★ obj 파라미터가 최상위 클래스인 Object로, 모든 클래스의 인스턴스를 업캐스팅 받을 수 있지만, 업캐스팅 받더라도 '업캐스팅 받은 자식클래스로만 다운캐스팅이 가능'하기에,
			    obj가 Book4로 다운캐스팅 가능한 조건인 Book4의 '자식클래스'이거나, Book4클래스가 아닐 경우엔 obj를 Book4 클래스로 다운캐스팅이 불가능하다.*/ 
			// 즉, 파라미터로 전달받는 obj는 Book4클래스이거나, Book4를 상속받고있는 Book4의 자식클래스일 경우를 제외하곤 Book4로 다운캐스팅 불가
			return false;
