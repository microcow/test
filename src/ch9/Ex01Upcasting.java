...
public class Ex01Upcasting {
	public static void main(String[] args) {
		...
		// 부모 타입에 자식 타입의 인스턴스 변수 구조를 저장하는 것을 업캐스팅이라 한다. (자식을 부모에 저장한다)
		// ★ book(부모클래스의 인스턴스)은 EBook클래스(자식클래스)의 인스턴스 변수 구조를 가지고 있지만, 부모클래스 소속이므로 자식 클래스의 메소드나 인스턴스 변수를 사용할 수 없다. ★ (* ch8 Ex01)
		// 자식클래스는 부모클래스의 인스턴스 변수도 가지고 있으니 업캐스팅 시 자식클래스의 인스턴스 변수까지 가지므로 갖고있는 인스턴스 변수가 늘어나는 것
		// 질문 1 - 자식클래스의 인스턴스 변수도 사용 불가한가? (EBook 클래스 구조를 가지고있는데?) = yes 사용 불가 (부모클래스의 메소드와 인스턴스 변수만 사용 가능 만약, 사용하고 싶다면 다운캐스팅 필요)
