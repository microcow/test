...
public class Ex02Array {
	public static void main(String[] args) {
		...
		// 해당 배열이 다차원일 경우 해당 차원의 길이가 나오게됨 (ex. 2차원일 경우 2차원 배열 길이(세로)/ 3차원일 경우 3차원 배열 길이(,로 구분된 {}길이))
		// 1차원 길이를 알고 싶을 경우, arr4[0].length 또는 arr4[1].length 과 같이 입력하면 됨 (2차원 이상일 경우) (arr3[1차원].length로 입력)
		// 2차원 길이를 알고 싶을 경우, arr3[0][0].length 과 같이 입력하면 됨 (3차원 이상일 경우) (arr3[3차원],[2차원].length로 입력)
